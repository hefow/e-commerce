  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-blue-500 p-4 text-white">
      ...
      <nav className="space-y-4">
        ...
        <Link to="/category" className="flex items-center space-x-2 p-2 hover:bg-blue-600">
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
          </svg>
          <span>Category</span>
        </Link>
        <Link to="/category/all" className="flex items-center space-x-2 p-2 hover:bg-blue-600">
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
          </svg>
